...
function bootstrapwp_widgets_init() {
    ...
    register_sidebar(
        array(
            'name'          => __('Hub Sidebar', 'bootstrapwp'),
            'id'            => 'sidebar-hub',
    ...
    register_sidebar(
        array(
            'name'          => __('Posts Sidebar2', 'bootstrapwp'),
            'id'            => 'sidebar-posts2',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h4 class="widget-title">',
    ...
    register_sidebar(
        array(
            'name'          => __('Posts Sidebar3', 'bootstrapwp'),
            'id'            => 'sidebar-posts3',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h4 class="widget-title">',
...
echo wp_trim_words($content, $word_count_limit) . ' <a href="' . get_permalink( get_the_ID() ) . '"><p style="text-align:right;"><button class="read-more"> READ MORE</button></p></a>';
}
